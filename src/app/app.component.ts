...
export class AppComponent implements OnInit {
  ...
  duaas: string[] = [
    ...
    'اللَّهُمَّ ثَبِّتْنِي بِالْقَوْلِ الثَّابِتِ فِي الْحَيَاةِ الدُّنْيَا وَفِي الْآخِرَةِ',
    ...
    'اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْبُخْلِ، وَأَعُوذُ بِكَ مِنَ الْجُبْنِ، وَأَعُوذُ بِكَ مِنْ أَنْ نُرَدَّ إِلَى أَرْذَلِ الْعُمُرِ، وَأَعُوذُ بِكَ مِنْ فِتْنَةِ الدُّنْيَا، وَأَعُوذُ بِكَ مِنْ عَذَابِ الْقَبْرِ',
    ...
    'اللَّهُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ، وَالْمُعَافَاةَ الدَّائِمَةَ فِي الدِّينِ وَالدُّنْيَا وَالآخِرَةِ',
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      const finisherElement = document.getElementById('finisher-header-light');
      ...
      if (finisherElement) {
        ...
        if (typeof FinisherHeader !== 'undefined') new FinisherHeader(config);
      }
    }, 1000);
    setTimeout(() => {
      const finisherElement2 = document.getElementById('finisher-header-dark');

      if (finisherElement2) {
        // Log the configuration to ensure everything is valid
        const config = {
          "count": 100,
          "size": {
            "min": 2,
